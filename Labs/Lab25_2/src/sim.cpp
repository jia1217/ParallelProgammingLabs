...
void read_bin_files()
{
    ...
    read_conv_weight <64,32,3,3> ("conv_layer3_weights.bin", conv3_weights);
    read_conv_bias <64> ("conv_layer3_bias.bin", conv3_bias);

    read_conv_weight <64,64,3,3> ("conv_layer4_weights.bin", conv4_weights);
    read_conv_bias <64> ("conv_layer4_bias.bin", conv4_bias);

    read_fc_weight <128,4096> ("fc1_weights.bin", fc1_weights);
    read_fc_bias <128> ("fc1_bias.bin", fc1_bias);

    read_fc_weight <10,128> ("fc2_weights.bin", fc2_weights);
    read_fc_bias <10> ("fc2_bias.bin", fc2_bias);
}
