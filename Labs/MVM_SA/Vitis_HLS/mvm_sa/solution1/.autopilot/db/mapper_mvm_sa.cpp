...
unsigned int ap_apatb_A_stream_V_data_V_cap_bc;
static AESL_RUNTIME_BC __xlx_A_stream_V_data_V_V_size_Reader("../tv/stream_size/stream_size_in_A_stream_V_data_V.dat");
unsigned int ap_apatb_A_stream_V_keep_V_cap_bc;
static AESL_RUNTIME_BC __xlx_A_stream_V_keep_V_V_size_Reader("../tv/stream_size/stream_size_in_A_stream_V_keep_V.dat");
unsigned int ap_apatb_A_stream_V_strb_V_cap_bc;
static AESL_RUNTIME_BC __xlx_A_stream_V_strb_V_V_size_Reader("../tv/stream_size/stream_size_in_A_stream_V_strb_V.dat");
unsigned int ap_apatb__cap_bc;
static AESL_RUNTIME_BC __xlx__V_size_Reader("../tv/stream_size/stream_size_in_.dat");
unsigned int ap_apatb_A_stream_V_last_V_cap_bc;
static AESL_RUNTIME_BC __xlx_A_stream_V_last_V_V_size_Reader("../tv/stream_size/stream_size_in_A_stream_V_last_V.dat");
unsigned int ap_apatb__cap_bc;
static AESL_RUNTIME_BC __xlx__V_size_Reader("../tv/stream_size/stream_size_in_.dat");
unsigned int ap_apatb__cap_bc;
static AESL_RUNTIME_BC __xlx__V_size_Reader("../tv/stream_size/stream_size_in_.dat");
...
unsigned int ap_apatb__cap_bc;
static AESL_RUNTIME_BC __xlx__V_size_Reader("../tv/stream_size/stream_size_out_.dat");
extern "C" void mvm_sa(volatile void *, volatile void *, volatile void *, , volatile void *, , , volatile void *, volatile void *, volatile void *, , volatile void *, , , volatile void *, volatile void *, volatile void *, , volatile void *, , );
extern "C" void apatb_mvm_sa_hw(volatile void * __xlx_apatb_param_A_stream_V_data_V, volatile void * __xlx_apatb_param_A_stream_V_keep_V, volatile void * __xlx_apatb_param_A_stream_V_strb_V, volatile void * __xlx_apatb_param_A_stream_V_last_V, volatile void * __xlx_apatb_param_x_stream_V_data_V, volatile void * __xlx_apatb_param_x_stream_V_keep_V, volatile void * __xlx_apatb_param_x_stream_V_strb_V, volatile void * __xlx_apatb_param_x_stream_V_last_V, volatile void * __xlx_apatb_param_y_stream_V_data_V, volatile void * __xlx_apatb_param_y_stream_V_keep_V, volatile void * __xlx_apatb_param_y_stream_V_strb_V, volatile void * __xlx_apatb_param_y_stream_V_last_V) {
  // collect __xlx_A_stream_V_data_V_tmp_vec
  unsigned __xlx_A_stream_V_data_V_V_tmp_Count = 0;
  unsigned __xlx_A_stream_V_data_V_V_read_Size = __xlx_A_stream_V_data_V_V_size_Reader.read_size();
  vector<int> __xlx_A_stream_V_data_V_tmp_vec;
  while (!((hls::stream<int>*)__xlx_apatb_param_A_stream_V_data_V)->empty() && __xlx_A_stream_V_data_V_V_tmp_Count < __xlx_A_stream_V_data_V_V_read_Size) {
    __xlx_A_stream_V_data_V_tmp_vec.push_back(((hls::stream<int>*)__xlx_apatb_param_A_stream_V_data_V)->read());
    __xlx_A_stream_V_data_V_V_tmp_Count++;
  }
  ap_apatb_A_stream_V_data_V_cap_bc = __xlx_A_stream_V_data_V_tmp_vec.size();
  // store input buffer
  int* __xlx_A_stream_V_data_V_input_buffer= new int[__xlx_A_stream_V_data_V_tmp_vec.size()];
  for (int i = 0; i < __xlx_A_stream_V_data_V_tmp_vec.size(); ++i) {
    __xlx_A_stream_V_data_V_input_buffer[i] = __xlx_A_stream_V_data_V_tmp_vec[i];
  }
  // collect __xlx_A_stream_V_keep_V_tmp_vec
  unsigned __xlx_A_stream_V_keep_V_V_tmp_Count = 0;
  unsigned __xlx_A_stream_V_keep_V_V_read_Size = __xlx_A_stream_V_keep_V_V_size_Reader.read_size();
  vector<char> __xlx_A_stream_V_keep_V_tmp_vec;
  while (!((hls::stream<char>*)__xlx_apatb_param_A_stream_V_keep_V)->empty() && __xlx_A_stream_V_keep_V_V_tmp_Count < __xlx_A_stream_V_keep_V_V_read_Size) {
    __xlx_A_stream_V_keep_V_tmp_vec.push_back(((hls::stream<char>*)__xlx_apatb_param_A_stream_V_keep_V)->read());
    __xlx_A_stream_V_keep_V_V_tmp_Count++;
  }
  ap_apatb_A_stream_V_keep_V_cap_bc = __xlx_A_stream_V_keep_V_tmp_vec.size();
  // store input buffer
  char* __xlx_A_stream_V_keep_V_input_buffer= new char[__xlx_A_stream_V_keep_V_tmp_vec.size()];
  for (int i = 0; i < __xlx_A_stream_V_keep_V_tmp_vec.size(); ++i) {
    __xlx_A_stream_V_keep_V_input_buffer[i] = __xlx_A_stream_V_keep_V_tmp_vec[i];
  }
  // collect __xlx_A_stream_V_strb_V_tmp_vec
  unsigned __xlx_A_stream_V_strb_V_V_tmp_Count = 0;
  unsigned __xlx_A_stream_V_strb_V_V_read_Size = __xlx_A_stream_V_strb_V_V_size_Reader.read_size();
  vector<char> __xlx_A_stream_V_strb_V_tmp_vec;
  while (!((hls::stream<char>*)__xlx_apatb_param_A_stream_V_strb_V)->empty() && __xlx_A_stream_V_strb_V_V_tmp_Count < __xlx_A_stream_V_strb_V_V_read_Size) {
    __xlx_A_stream_V_strb_V_tmp_vec.push_back(((hls::stream<char>*)__xlx_apatb_param_A_stream_V_strb_V)->read());
    __xlx_A_stream_V_strb_V_V_tmp_Count++;
  }
  ap_apatb_A_stream_V_strb_V_cap_bc = __xlx_A_stream_V_strb_V_tmp_vec.size();
  // store input buffer
  char* __xlx_A_stream_V_strb_V_input_buffer= new char[__xlx_A_stream_V_strb_V_tmp_vec.size()];
  for (int i = 0; i < __xlx_A_stream_V_strb_V_tmp_vec.size(); ++i) {
    __xlx_A_stream_V_strb_V_input_buffer[i] = __xlx_A_stream_V_strb_V_tmp_vec[i];
  }
  // collect __xlx_A_stream_V_last_V_tmp_vec
  unsigned __xlx_A_stream_V_last_V_V_tmp_Count = 0;
  unsigned __xlx_A_stream_V_last_V_V_read_Size = __xlx_A_stream_V_last_V_V_size_Reader.read_size();
  vector<char> __xlx_A_stream_V_last_V_tmp_vec;
  while (!((hls::stream<char>*)__xlx_apatb_param_A_stream_V_last_V)->empty() && __xlx_A_stream_V_last_V_V_tmp_Count < __xlx_A_stream_V_last_V_V_read_Size) {
    __xlx_A_stream_V_last_V_tmp_vec.push_back(((hls::stream<char>*)__xlx_apatb_param_A_stream_V_last_V)->read());
    __xlx_A_stream_V_last_V_V_tmp_Count++;
  }
  ap_apatb_A_stream_V_last_V_cap_bc = __xlx_A_stream_V_last_V_tmp_vec.size();
  // store input buffer
  char* __xlx_A_stream_V_last_V_input_buffer= new char[__xlx_A_stream_V_last_V_tmp_vec.size()];
  for (int i = 0; i < __xlx_A_stream_V_last_V_tmp_vec.size(); ++i) {
    __xlx_A_stream_V_last_V_input_buffer[i] = __xlx_A_stream_V_last_V_tmp_vec[i];
  }
  ...
  // DUT call
  mvm_sa(__xlx_A_stream_V_data_V_input_buffer, __xlx_A_stream_V_keep_V_input_buffer, __xlx_A_stream_V_strb_V_input_buffer, __xlx_A_stream_V_last_V_input_buffer, __xlx_x_stream_V_data_V_input_buffer, __xlx_x_stream_V_keep_V_input_buffer, __xlx_x_stream_V_strb_V_input_buffer, __xlx_x_stream_V_last_V_input_buffer, __xlx_y_stream_V_data_V_input_buffer, __xlx_y_stream_V_keep_V_input_buffer, __xlx_y_stream_V_strb_V_input_buffer, __xlx_y_stream_V_last_V_input_buffer);
