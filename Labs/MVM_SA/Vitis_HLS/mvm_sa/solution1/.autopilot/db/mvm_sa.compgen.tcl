...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { x_stream_TDATA { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { x_stream_TVALID { I 1 bit } x_stream_TREADY { O 1 bit } x_stream_TLAST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { y_stream_TDATA { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { y_stream_TVALID { O 1 bit } y_stream_TREADY { I 1 bit } y_stream_TLAST { O 1 vector } } \
} "
} else {
