...
In either part, we will multiply a 100 x 200 matrix with a 200 x 300 matrix to get a 100 x 300 matrix product and accelerate the design for the Pynq-Z2 board.
