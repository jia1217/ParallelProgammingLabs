...
a simple 2-to-1 multiplexer and extend the design to multiple bits. Here is some useful link for using the [vivado](https://www.xilinx.com/video/hardware/getting-started-with-the-vivado-ide.html)[install vivado](https://eclipse.umbc.edu/robucci/cmpe415/hw1/vivado.html).
